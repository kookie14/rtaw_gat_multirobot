#pragma once
#ifndef SINGLE_RECONSTRUCT_H_
#define SINGLE_RECONSTRUCT_H_

#include "env/reconstruct_interface.h"
namespace rds
{
    class SingleReconstruction: public ReconstructInterface
    {
    private:
    ...
    public:
        SingleReconstruction(std::string data_path = "");
